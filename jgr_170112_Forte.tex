...
%170102 \titlerunninghead{BOUNDARY CURRENT IN MINI-MAGNETOSPHERE}
...
Electron dynamics in the mini-magnetosphere above a lunar magnetic anomaly
...
%%170108 Since for the plasma, we do not consider the finite Larmor radius effect,  
...
%170112 it was found that at the magnetopause,
...
%170107 the plasma flow was parallel to the lunar surface, and the magnetic dipole was perpendicular to
...
%170108 We did not consider particles crossing the lunar surface or other simulation boundaries. 
...
For convenience, 
%170108 we define the regions of positive and negative $y$ as the R-hand and L-hand 
%hemispheres, respectively.
we define the regions of positive and negative $y$ as the +E and -E hemispheres, respectively.
%In the +E hemisphere the convection electric field $E_\mathrm{0}$ is pointing away from the 
%magnetic anomaly 
%and in the −E hemisphere $E_\mathrm{0}$ towards the magnetic anomaly along the $y$ direction.
...
previous studies
\citep[e.g.,][]{Harnett2000,Harnett2003,Halekas2008b,Bamford2012}.
%170108 The size of the mini-magnetosphere was less than $0.5L$.
...
%%170108 within $|z|/L$ = 0.5 of the inner magnetosphere; this region is shown in red. 
...
\caption{
%170112 Vectors of electron flux superimposed on the contour map 
...
%
%170112 In each panel, the contour map shown beneath the vectors indicates the electron density.
...
%170108 , creating a region of high electron density along the boundary.
...
%170112 superimposed on the electron density contour map of the corresponding plane.
...
%170112 The contour map indicates an asymmetric density cavity 
...
%170108, particularly when they are evaluated in the same region.
%%
%% - Figure 9-
%%
\begin{figure}
...
%170108 which is evaluated in the PIC simulation. 
...
%170112 , which corresponds to movement from the -E to the +E hemisphere.
...
%%we see a quantitative difference between $<v_{y-sim}>$ and 
%%the $\mbox{\boldmath $E$} \times \mbox{\boldmath $B$}$ velocity.
In this region, 
%%170108
%%in which $x/L > -0.5$, including the edge of the inner boundary layer, 
...
%170108
%%This is why the electrons with a positive $v_y$ are missing in Figure \ref{fig:10} (c).
%%This filtering due to the finite Larmor radius of the ECM 
%%causes the maximum $v_y$ value, $|v_y|/v_\mathrm{flow}=8$, to occur  
%%around $x/L = -0.4$, as
%170108 shown in both Figures \ref{fig:9} and \ref{fig:10} (black curves). 
...
\section{Conclusions}
%170108 We studied the boundary layer current in 
...
%170112 the spatial filtering caused by 
